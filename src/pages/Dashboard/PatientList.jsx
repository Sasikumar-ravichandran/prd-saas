...
export default function PatientList() {
  ...
  // --- REUSABLE PAYMENT CHIP LOGIC ---
  const getPaymentChip = (cost, paid) => {
  ...
  return (
    <Box sx={{ bgcolor: '#f8fafc', minHeight: '100vh', display: 'flex', flexDirection: 'column', gap: 3 }}>
        ...
        <Stack direction="row" justifyContent="space-between" alignItems="center" mb={3}>
          ...
          <Stack direction="row" spacing={1.5}>
            ...
            <Button
              ...
              sx={{ bgcolor: primaryColor, borderRadius: 2, px: { xs: 2, sm: 3 }, fontWeight: 'bold', boxShadow: 'none' }}
            >
              <AddIcon sx={{ mr: { xs: 0, sm: 0.5 } }} />
              <Box component="span" sx={{ display: { xs: 'none', sm: 'inline' } }}>Add Patient</Box>
            </Button>
          </Stack>
        </Stack>
      ...
      <Paper elevation={0} sx={{ border: '1px solid #e2e8f0', borderRadius: 3, overflow: 'hidden', display: 'flex', flexDirection: 'column', flex: 1, boxShadow: '0 4px 20px rgba(0,0,0,0.02)' }}>
        ...
        <Box sx={{ px: 3, py: 2, borderBottom: '1px solid #f1f5f9', display: 'flex', flexWrap: 'wrap', gap: 2, justifyContent: 'space-between', alignItems: 'center', bgcolor: 'white' }}>
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} sx={{ width: { xs: '100%', md: 'auto' } }}>
            ...
            <Paper component="form" elevation={0} sx={{ p: '4px 12px', display: 'flex', alignItems: 'center', width: { xs: '100%', sm: 280 }, borderRadius: 2, bgcolor: '#f8fafc', border: '1px solid #e2e8f0' }}>
        ...
        {/* 3. SERVER-SIDE PAGINATION (Visible on both desktop and mobile) */}
        <TablePagination
          component="div"
          count={totalCount}
          page={page}

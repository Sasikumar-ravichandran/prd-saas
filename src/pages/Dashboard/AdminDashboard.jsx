    ...
    <Box sx={{ p: 1, bgcolor: '#f8fafc', minHeight: '100vh', display: 'flex', flexDirection: 'column', gap: 3 }}>
      ...
      <Box sx={{ p: 1, maxWidth: '1600px' }}>
        <Stack spacing={4}>
          ...
          {/* 3. TRANSACTION STREAM (Limited to last 5 records) */}
              ...
              <Table>
                ...
                <TableBody>
                  {data.transactions.length === 0 ? (
                    ...
                    data.transactions.slice(0, 5).map((row, i) => (
              ...
              <Stack spacing={2} sx={{ overflowY: 'auto', flex: 1, pr: 1, maxHeight: '300px' }}>
                {inventoryAlerts.length > 0 ? (
                  inventoryAlerts.map((item, i) => (
                    <Box key={i} sx={{ p: 1.5, bgcolor: '#fffbeb', borderRadius: 2, display: 'flex', justifyContent: 'space-system', alignItems: 'center', border: '1px solid #fde68a' }}>
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>

    ...
    <>
      ...
      <Menu
        ...
        PaperProps={{
          elevation: 3,
          sx: {
            borderRadius: 3, minWidth: 160, mt: 1,
      ...
      <Stack direction={{ xs: 'column', md: 'row' }} justifyContent="space-between" alignItems={{ xs: 'flex-start', md: 'center' }} mb={3} spacing={2}>
        ...
        <Stack direction="row" spacing={2} sx={{ width: { xs: '100%', md: 'auto' } }}>
          <TextField
            ...
            sx={{ flex: 1, minWidth: { sm: 280 }, bgcolor: '#fff', '& .MuiOutlinedInput-root': { borderRadius: 3, '& fieldset': { borderColor: '#e2e8f0' } } }}
          />
          <Button 
            variant="contained" 
            onClick={() => { setSelectedItem(null); setFormMode('create'); }}
            sx={{ 
              ...
              textTransform: 'none', 
              fontWeight: 'bold',
              minWidth: { xs: 'auto', sm: '120px' }, // Fix button width on mobile
              boxShadow: 'none'
            }}
          >
